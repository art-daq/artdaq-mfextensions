# https://raw.githubusercontent.com/mfontanini/cppkafka/refs/heads/master/cmake/FindRdKafka.cmake
...
set(RdKafkapp_LIBNAME ${RDKAFKA_PREFIX}rdkafka++${RDKAFKA_SUFFIX})
...
find_library(RdKafkapp_LIBRARY_PATH
    NAMES ${RdKafkapp_LIBNAME} rdkafka++
    HINTS ${RdKafka_ROOT}/lib ${RdKafka_ROOT}/lib64
)
...
if (RdKafka_FOUND)
    ...
    set_target_properties(RdKafka::rdkafka++ PROPERTIES
            IMPORTED_LOCATION "${RdKafkapp_LIBRARY_PATH}"
            INTERFACE_INCLUDE_DIRECTORIES "${RdKafka_INCLUDE_DIR}"
            INTERFACE_LINK_LIBRARIES "${RDKAFKA_DEPENDENCIES}")
